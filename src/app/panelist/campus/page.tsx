...
export default async function PanelistCampusPage() {
  ...
  // This portal is Campus Hiring only — Lateral Hiring lives entirely at /recalibrate.
    ...
    <div className="app-shell">
        ...
        <div className="app-container app-header-inner" style={{ maxWidth: '1200px' }}>
          <div className="brand-lockup">
            ...
            <div>
              ...
              <div className="brand-context">Campus Hiring Portal</div>
            </div>
          </div>
      ...
      <footer className="app-footer">
        <div className="app-container flex-between text-muted text-xs" style={{ maxWidth: '1200px' }}>
          <p>© 2026 PanelSync. Campus Hiring Portal.</p>
        </div>
      </footer>
    </div>
  );
