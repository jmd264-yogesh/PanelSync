...
export default function PanelistClient({
  initialInterviews,
  initialRequests,
  panelistRoles,
  panelistName,
  ...
  const [pendingRequests, setPendingRequests] =
    useState<{ interview: Interview; panel: InterviewPanel }[]>(
      initialRequests,
    );
  ...
  const fetchL1FeedbackForCandidate = async (
  ...
  const [l1Ratings, setL1Ratings] = useState<
    ...
    >
  >({});
  const [l2Ratings, setL2Ratings] = useState<
    Record<
      string,
      {
        design: number;
    ...
    >
  >({});
  const [genRatings, setGenRatings] = useState<
    Record<
      string,
      {
        technical: number;
  ...
  const performFeedbackSubmit = async (
    interview: PanelistInterview,
    decision: "PASSED" | "REJECTED",
  ) => {
    const roleLower = interview.role.toLowerCase();
    ...
    try {
      ...
      setFeedbackError((prev) => ({
        ...prev,
        [interview.panelId]: err.message || "Failed to submit",
      }));
    } finally {
            ...
            style={{
              ...
              background:
                activePrimaryTab === "PANELS"
                  ...
                  : "var(--border-glass)",
              color:
                activePrimaryTab === "PANELS" ? "#ffffff" : "var(--text-muted)",
              padding: "2px 8px",
              borderRadius: "12px",
              fontWeight: 700,
            }}
                ...
                style={{
                  ...
                  background:
                    activeRoundTab === "ALL"
                      ...
                      : "var(--border-glass)",
                  color:
                    activeRoundTab === "ALL" ? "#ffffff" : "var(--text-muted)",
                  padding: "1px 6px",
                  borderRadius: "4px",
                  fontWeight: 700,
                }}
              ...
              style={{
                ...
                background:
                  activeRoundTab === "L1"
                    ...
                    : "transparent",
                color:
                  activeRoundTab === "L1" ? "#0ea5e9" : "var(--text-muted)",
                fontSize: "0.8rem",
                fontWeight: 600,
                cursor: "pointer",
                transition: "var(--transition-fast)",
            ...
            >
              ...
              <span
                style={{
                  ...
                  color:
                    activeRoundTab === "L1" ? "#ffffff" : "var(--text-muted)",
                  padding: "1px 6px",
                  borderRadius: "4px",
                  fontWeight: 700,
                }}
              ...
              style={{
                ...
                background:
                  activeRoundTab === "L2"
                    ...
                    : "transparent",
                color:
                  activeRoundTab === "L2" ? "#7c3aed" : "var(--text-muted)",
                fontSize: "0.8rem",
                fontWeight: 600,
                cursor: "pointer",
                transition: "var(--transition-fast)",
            ...
            >
              ...
              <span
                style={{
                  ...
                  color:
                    activeRoundTab === "L2" ? "#ffffff" : "var(--text-muted)",
                  padding: "1px 6px",
                  borderRadius: "4px",
                  fontWeight: 700,
                }}
            ...
            {filteredSortedRequests.length === 0 ? (
              ...
              >
                {filteredSortedRequests.map((req) => {
                  ...
                  const isL1Role = req.interview.role
                    .toLowerCase()
                    .includes("l1");
                  const isL2Role = req.interview.role
                    .toLowerCase()
                    .includes("l2");
                  const borderCol = isL1Role
                    ? "#0ea5e9"
                    : isL2Role
                      ? "#7c3aed"
                      : "var(--primary)";
                  ...
                  const collegeName = getCollegeNameFromRole(
                    req.interview.role,
                  );
                  const isReqFromActiveDrive = isFromActiveDrive(
                    req.interview.role,
                  );
                    ...
                    >
                      <div>
                        ...
                        >
                          ...
                          <div className="text-muted text-xs">
                            Duration:{" "}
                            <strong>{req.interview.duration} minutes</strong>
                          </div>
                        </div>
                      </div>
                      <button
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            >
              ...
              {filteredSortedInterviews.length !== interviews.length && (
                ...
                >
                  ({filteredSortedInterviews.length} of {interviews.length}{" "}
                  shown)
                </span>
              )}
            </h2>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <textarea
                                          ...
                                          value={current.comments}
                                          onChange={(e) =>
                                            updateL1("comments", e.target.value)
                                          }
                                          disabled={isSubmitting}
                                        />
                                      </div>
                                      ...
                                      >
                                        <strong>⚠️ L1 Decision Warning:</strong>{" "}
                                        Submitting a <strong>Pass L1</strong>{" "}
                                        decision is final. The candidate will
                                        immediately progress to the L2 queue,
                                        and you will not be able to edit or
                                        revert this feedback.
                                      </div>
                                ...
                                if (isL2Role) {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      >
                                        Evaluating L2 System Design &amp; Fit
                                        Metrics:
                                      </div>
