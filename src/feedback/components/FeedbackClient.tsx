...
type TFeedbackClientProps = {
  interview: Interview;
  panel: InterviewPanel;
};

export const FeedbackClient = ({ interview, panel }: TFeedbackClientProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setErrorMsg((err as Error).message || 'An error occurred. Please try again.');
    } finally {
