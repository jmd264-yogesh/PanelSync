...
import { buildPanelistReportHtml, printHtmlDocument } from '@server/util/pdf/recalibrate-print';
...
export const RecalibrateReportModal = function RecalibrateReportModal({
  candidateId,
  onClose,
}: {
  candidateId: string;
