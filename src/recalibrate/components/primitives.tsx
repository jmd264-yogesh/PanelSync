...
export const SectionHeader = ({ icon, title, right }: { icon: React.ReactNode; title: string; right?: React.ReactNode }) => {
  return (
...
export const ScoreDial = ({ value, selected, onSelect, size = 30 }: { value: number; selected: boolean; onSelect: () => void; size?: number }) => {
...
export const ScoreLegend = ({ compact = false }: { compact?: boolean }) => {
  return (
