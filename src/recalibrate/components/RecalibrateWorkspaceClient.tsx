...
import { CandidateRail, type CandidateStatus } from './CandidateRail';
import { RecalibrateWorkspace } from './RecalibrateWorkspace';

type TRecalibrateWorkspaceClientProps = {
  initialInterviews: PanelistInterview[];
  panelistName: string;
};

export const RecalibrateWorkspaceClient = ({
  initialInterviews,
  panelistName,
}: TRecalibrateWorkspaceClientProps) => {
