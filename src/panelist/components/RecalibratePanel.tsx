...
import { SectionHeader, ScoreDial, ProgressBar, ScoreLegend, RubricRow, DIFFICULTY_STYLE } from '@/recalibrate/components/primitives';

type TRecalibratePanelProps = {
  interviewId: string;
...
export const RecalibratePanel = ({
  interviewId,
  candidateName,
  positionTitle,
  panelistName,
}: TRecalibratePanelProps) => {
