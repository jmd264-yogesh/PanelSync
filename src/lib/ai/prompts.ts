...
- "modelAnswer" is a strong reference answer (2-4 sentences, or a short bullet list) that would sit at the top rubric band — for the panelist's own reference during scoring, never shown to the candidate.
